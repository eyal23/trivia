...
/*
    ...
    out: no
*/
RoomAdminRequestHandler::RoomAdminRequestHandler(int roomId, LoggedUser loggedUser) :
...
{
    RoomManager::getInstance().closeRoom(this->m_roomId);
...
{
	RoomManager::getInstance()[this->m_roomId].activateRoom();
